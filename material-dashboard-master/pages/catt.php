  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="../pages/catt.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">dashboard</i>
            </div>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3 d-flex justify-content-between pe-3">Category table
                  ...
                  <tbody>
                    ...
                    echo "<tr>";
                      ...
                      echo "<td class='align-middle text-center text-sm'>";
                        echo "<span class='text-secondary text-xs font-weight-bold'>",$row['cat'],"</span>";
                      echo "</td>";
                      echo "<td class='align-middle'>";
                        $a=$row['catid'];
                        echo "<a href='../pages/delete/catdel.php?id=$a' class='text-secondary font-weight-bold text-xs' data-toggle='tooltip' data-original-title='Edit user'>";
                          echo "Delete";
                        echo "</a>";
                      echo "</td>";
                    echo "</tr>";
...
<div class="input-field"><p>Enter Category:&nbsp;&nbsp;&nbsp;<input id="p1" placeholder="Category" name="name" class="validate" onBlur="checkAvailability()"></p></div>
...
if($r){
    ...
    echo"<script>location.href='../pages/catt.php'</script>";
}
mysqli_close($con);
      }
      ?>
