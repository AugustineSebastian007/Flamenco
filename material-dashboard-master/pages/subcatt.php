...
<body class="g-sidenav-show  bg-gray-200">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <!-- <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="../pages/subcatt.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">dashboard</i>
            </div>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3 d-flex justify-content-between pe-3">Sub-Category table
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Sub-Category Id</th>
                  ...
                  <tbody>
                    ...
                    echo "<tr>";
                      echo "<td>";
                        echo "<span class='text-secondary text-xs font-weight-bold'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;",$row['subcatid'],"</span>";
                      echo "</td>";
                      echo "<td class='align-middle text-center text-sm'>";
                        echo "<span class='text-secondary text-xs font-weight-bold'>",$row['subcat'],"</span>";
                      echo "</td>";
                      echo "<td class='align-middle text-center text-sm'>";

                      $id=$row["catid"];
                      $qr="select * from cat where catid = '$id'";
                      $rr=mysqli_query($con,$qr);
                      $ro=mysqli_fetch_array($rr);
                        echo "<span class='text-secondary text-xs font-weight-bold'>",$ro['cat'],"</span>";


                      echo "</td>";
                      echo "<td class='align-middle'>";
                      $a=$row['subcatid'];
                        echo "<a href='../pages/delete/subcatdel.php?id=$a' class='text-secondary font-weight-bold text-xs' data-toggle='tooltip' data-original-title='Edit user'>";
                          echo "Delete";
                        echo "</a>";
                      echo "</td>";
                    echo "</tr>";
  ...
  <div class="popup" id="popup-1">
    ...
    <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="input-field"><p>Enter Category:&nbsp;&nbsp;&nbsp;<input id="p1" placeholder="Category" name="name" class="validate"></p></div>
...
<?php
  if(isset($_POST["sub"])){
          ...
          $y=$_POST["cat"];
          $con=mysqli_connect("localhost","root","","music");
          $q="INSERT INTO `subcat`(`catid`,`subcat`) VALUES ('$y','$x')";
          $r=mysqli_query($con,$q);
          if($r){
              echo "<script>alert('value added successfully')</script>";
              echo"<script>location.href='../pages/subcatt.php'</script>";
          }
          mysqli_close($con);
        }
      ?>
