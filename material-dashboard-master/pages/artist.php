  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="../pages/artist.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3 d-flex justify-content-between pe-3">Artist table
                ...
                <table class="table align-items-center mb-0" >
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Slno</th>
                    ...
                    echo "<tr>";
                      ...
                      echo "<div class='d-flex px-2 py-1'>";
                        ...
                        echo "<div class='my-auto'>";
                          echo "<span class='text-secondary text-xs font-weight-bold'>&nbsp;&nbsp;&nbsp;",$row['artist'],"</span>";
                        echo "</div>";
                      echo "</div>";
                      echo "</td>";
                      ...
                      echo "<td class='align-middle'>";
                        $a=$row['artistid'];
                        echo "<a href='../pages/delete/artdel.php?id=$a' class='text-secondary font-weight-bold text-xs' data-toggle='tooltip' name='subb' data-original-title='Edit user'>";
                          echo "Delete";
                        echo "</a>";
                      echo "</td>";
                    echo "</tr>";
...
<div class="input-field"><p>Enter Name:&nbsp;&nbsp;&nbsp;<input id="p1" placeholder="Name" name="name" class="validate" onBlur="checkAvailability()"></p>
...
if($r){
    ...
    echo"<script>location.href='../pages/artist.php'</script>";
}
mysqli_close($con);
      }
      ?>
