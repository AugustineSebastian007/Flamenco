  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="../pages/stut.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">dashboard</i>
            </div>
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Album</li>
          </ol>
        </nav>
      </div>
    </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3 d-flex justify-content-between pe-3">Album table
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Album Id</th>
                    ...
                    echo "<tr>";
                      ...
                      echo "<div class='d-flex px-2 py-1'>";
                        ...
                        echo "<div class='my-auto'>";
                          echo "<span class='text-secondary text-xs font-weight-bold'>&nbsp;&nbsp;&nbsp;",$row['album'],"</span>";
                        echo "</div>";
                      echo "</div>";
                      echo "</td>";
                      ...
                      $a=$row['albumid'];
                        echo "<a href='../pages/delete/studel.php?id=$a' class='text-secondary font-weight-bold text-xs' data-toggle='tooltip' data-original-title='Edit user'>";
                          echo "Delete";
                        echo "</a>";
                      echo "</td>";
                    echo "</tr>";
...
$con=mysqli_connect("localhost","root","","music");
$q="INSERT INTO `album`(`img`, `album`) VALUES ('$image','$x')";
$r=mysqli_query($con,$q);
if($r)
{
  $targetDir="uploads/";
...
if($r){
    ...
    echo"<script>location.href='../pages/stut.php'</script>";
}
mysqli_close($con);
      }
      ?>
