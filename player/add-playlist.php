                                    ...
                                    <div class="mat-tabs">
                                        <ul class="nav nav-tabs" id="add_music" role="tablist">
                                            <li class="nav-item" role="presentation"><button class="nav-link active"
                                                    ...
                                                    aria-selected="true">Add Playlist</button></li>
                                            <!-- <li class="nav-item" role="presentation"><button class="nav-link" id="album"
                                                    data-bs-toggle="tab" data-bs-target="#album_pane" type="button"
                                                    role="tab" aria-controls="album_pane" aria-selected="false">Add
                                                    Album</button></li> -->
                                    ...
                                    <div class="tab-content" id="add_music_content">
                                      <!-- add music pane -->
                                        <div class="tab-pane fade show active" id="music_pane" role="tabpanel"
                                            ...
                                            <form action="javascript:void(0);" class="row" id="addPlaylistForm" method="post" enctype="multipart/form-data">

                                                <div class="col-12 mb-4"><input id="p1" type="text" name="name" class="form-control"
                                                        placeholder="Playlist name" onBlur="checkAvailability()"></div>
																												<span id="user-availability-status" ></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer text-center">
                                    <button  type="submit" onclick="addplay()" class="btn btn-primary" name="sub" style="min-width: 140px;">Add Playlist</button>
                                          <a href="genres.php" class="btn btn-outline-secondary">Cancel</a>
																			 </div>
                            </div>
                            </form>
                            <!-- end music panel -->
