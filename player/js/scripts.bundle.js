...
var Base = (function() {
  var e = "active",
    ...
    a = function(a, r) {
      var l = $("#line_loader");
      l.show().animate({ width: 20 + 80 * Math.random() + "%" }, 200), $.ajax({
        url: a,
        type: "GET",
        dataType: "html"
      })
      ...
      if (
        (
          ...
          $(".swiper").each(function() {
            ...
            a &&
              (u.loop = a), i && (u.autoplay = { delay: 5e3, disableOnInteraction: !1, pauseOnMouseEnter: !0 }), n && r && (u.navigation = { nextEl: n, prevEl: r }), l && (u.pagination = { el: l, type: o, clickable: !0, dynamicBullets: !0 }), s && (u.scrollbar = { el: s, draggable: !0 }), new Swiper(this, u);
          }),
          document.querySelector(".dropzone") &&
            (
              (Dropzone.autoDiscover = !1),
              new Dropzone(".dropzone", { url: "/https/post" })
            ),
          (a = "mat-tabs__line"),
          (i = $("<span>", { class: a })),
          (n = $(".mat-tabs")),
  ...
  return {
    init: function() {
      $("#loader").fadeOut(1e3), t.settings(), n(), $(
        window
...
var Player = (function() {
  var e = "active",
    ...
    o = function(t = !0) {
      $("#player").addClass("show"), Amplitude.getSongs() &&
        ...
        callbacks: {
          song_change: function() {
            l(() => {
              v(), "playing" === Amplitude.getPlayerState()
                ? g()
                : $("[data-play-id]").removeClass(e), d(n);
            });
          }
        }
      });
    ...
    d = function(e) {
      ...
      t.find("[data-favorite-id]").attr("data-favorite-id", e.id), t
        .find("[data-playlist-id]")
        .attr("data-playlist-id", e.id), t
        .find("[download]")
        .attr("href", e.url);
    },
    p = function(e = !0) {
    ...
    c = function() {
      (i = []), p(), Amplitude.pause(), (n.player_state =
        "paused"), Utils.removeLocalItem("songs"), a.html(
    ...
    h = function() {
      $(".amplitude-play-pause")
        ...
        .addClass("amplitude-paused"), $("[data-play-id]").removeClass(e);
    },
    v = function() {
      ...
      !(function() {
        ...
        $(this).hasClass(e)
          ...
          : -1 === n
            ...
            : Amplitude.playSongAtIndex(n), Utils.setLocalItem("songs", i);
        ...
        .on("input", function() {
          var e = r.find(".ri-volume-mute-fill"),
            ...
            l = "d-block",
            o = "d-none";
          Player.volumeBackground(), 0 === n ? (e.removeClass(o).addClass(l), t.addClass(o), a.addClass(o)) : n > 0 && n < 70 ? (e.addClass(o), t.removeClass(o).addClass(l), a.addClass(o)) : n > 70 && (e.addClass(o), t.addClass(o), a.removeClass(o).addClass(l));
  ...
  e.fn.extend({
    ...
    var n,
      ...
      y = () => {
        ...
        Utils.setLocalItem(s, r), r.dark
          ? o.setAttribute(g, "dark")
          : o.removeAttribute(g), e &&
          i.header &&
          e.setAttribute(m, i.header), t &&
          i.sidebar &&
          t.setAttribute(h, i.sidebar), n &&
          i.player &&
          n.setAttribute(v, i.player);
      },
      f = (e, t, a) => {
    ...
    (l = Utils.getLocalItem(s)) &&
      (i = e.extend({}, i, l)), y(), (n = a.createElement(
      "div"
    ))
    
    // , (r = `<a href="javascript:void(0);" id="${d}_toggler">Settings</a>\n                    <div class="${d}__wrapper">\n                        <div class="${d}__head">${p}</div>\n                        <div class="${d}__body">`), (r += f(
    //   c,
    //   "Theme",
    //   "theme"
    // )), (r += f(u, "Header", "header")), (r += f(
    //   u,
    //   "Sidebar",
    //   "sidebar"
    // )), (r += f(u, "Player", "player")), (r +=
    //   '<p class="mt-4">Note: You can see the color change effect of the header, sidebar and player in the inner pages.</p></div></div>'), (n.id = d), (n.innerHTML = r), o.appendChild(
    //   n
    // )
    ...
    , b(), i.dark
      ...
      : e('[data-theme-option="light"]').addClass("active"), e(
      "[data-header-option=" + i.header + "]"
    ).addClass("active"), e("[data-sidebar-option=" + i.sidebar + "]").addClass(
      "active"
