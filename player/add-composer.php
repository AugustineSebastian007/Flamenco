                          ...
                          <!-- the add music card -->
                            <div class="card">
                                    ...
                                    <div class="mat-tabs">
                                        <ul class="nav nav-tabs" id="add_music" role="tablist">
                                            <li class="nav-item" role="presentation"><button class="nav-link active"
                                                    ...
                                                    aria-selected="true">Select Composer</button></li>
                                      ...
                                      <!-- add music pane -->
                                        <div class="tab-pane fade show active" id="music_pane" role="tabpanel"
                                            ...
                                            <form id="add-music-form" action="javascript:void(0);" class="row"  method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="col-12 mb-4"><select class="form-select" name="composer" id="cars"
                                ...
                                <div class="card-footer text-center">
                                    <button  type="submit" onclick="selectcomposer()" class="btn btn-primary" name="sub" style="min-width: 140px;">Select Composer</button>
                                         <button
                        ...
                        <div class="col-xl-7 col-md-10 mx-auto">
                          ...
                          <!-- the add music card -->
                            <div class="card">
                                    ...
                                    <div class="mat-tabs">
                                        <ul class="nav nav-tabs" id="add_music" role="tablist">
                                            <li class="nav-item" role="presentation"><button class="nav-link active"
                                                    id="music" data-bs-toggle="tab" data-bs-target="#music_pane"
                                                    type="button" role="tab" aria-controls="music_pane"
                                                    aria-selected="true">Add Composer</button></li>
                                ...
                                <div class="card-footer text-center">
                                    <button  type="submit" onclick="addcomposer()" class="btn btn-primary" name="submit" style="min-width: 140px;">Add Composer</button>
                                         <button
                                        class="btn btn-outline-secondary">Cancel</button></div>
                            ...
                            <!-- end music panel -->
                            <script>
												function selectcomposer() {
                                                    $("#loaderIcon").show();
                                                    jQuery.ajax({
                                                        url: "phpexec/selectcomposer.php",
                                                        data: 'composer=' + $("#cars").val(),
                                                        type: "POST",
