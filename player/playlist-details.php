    ...
    <div id="wrapper">
        ...
        <main id="page_content">
            ...
            <div class="under-hero container">
							...
							<?php
											$con=mysqli_connect("localhost","root","","music");
											$q="select playid,playname
											FROM playdetail
											WHERE playdetail.playid = '$x'";
								...
								<div class="section">
                                        ...
                                        src="images/background/horizontal/1.jpg" alt="Remix"></div>
												...
												<div class="col-md-8 mt-5 mt-md-0">
														...
														<div class="d-flex flex-wrap mb-2"><span class="text-dark fs-4 fw-semi-bold pe-2"><?php echo $row['playname'] ?></span>

														</div>
														<ul class="info-list info-list--dotted mb-3">
																<li>Playlist</li>
																<?php
																$qa="select playlist.playid, music.musicid, music.title
																			FROM playlist
																			INNER JOIN music ON playlist.musicid = music.musicid
																			WHERE playlist.playid = '$x'";
                ...
                <div class="section">
                    ...
                    <div class="list">
											<?php
														$con=mysqli_connect("localhost","root","","music");
														$qq="select COUNT(*) as 'count' from playlist where playid = '$x'";
                        ...
                        <div class="row"  data-collection-song-id="1">
                            <div class="col-xl-6">
															...
															<?php
                                      $con=mysqli_connect("localhost","root","","music");
                                      $q="select playlist.playid, music.musicid, music.title, music.artistid, music.catid, music.format, music.bitrate, music.duration, music.studio, music.lyrics, music.year, music.bpm, music.playcount, music.albumid, music.art, music.likecount, music.description, music.composerid, music.musicfile
                                      FROM playlist
                                      INNER JOIN music ON playlist.musicid = music.musicid
                                      WHERE playlist.playid = '$x'";
																			$r=mysqli_query($con,$q);
