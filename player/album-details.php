    ...
    <div id="wrapper">
        ...
        <main id="page_content">
            ...
            <div class="under-hero container">
              ...
              <?php
                      $con=mysqli_connect("localhost","root","","music");
                      $q="select * from album where albumid = '$x'";
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-3 col-md-4">
                            <div class="cover cover--round">
                                <div class="cover__image"><img class="profile" src="../material-dashboard-master/pages/uploads/<?php echo $row['img'] ?>" alt="Treasure face"></div>
                            </div>
                        </div>
                        <div class="col-1 d-none d-xl-block"></div>
                        <div class="col-md-8 mt-5 mt-md-0">
                            <div class="d-flex flex-wrap mb-2"><span class="text-dark fs-4 fw-semi-bold pe-2"><?php echo $row['album'] ?></span>
                            ...
                            <ul class="info-list info-list--dotted mb-3">
                                <li>Album</li>
																<?php
																$qa="select * from music where albumid = '$x'";
																$ra=mysqli_query($con,$qa);
																$rowcountb=mysqli_num_rows($ra);
																?>
                                <li><?php echo $rowcountb; ?> Songs</li>
                            </ul>
                            <p class="mb-5">By: <a class="text-dark fw-medium"><?php echo $row['album'] ?></a>
                            </p>
                            <ul class="info-list">
                                <li>
                                    <div class="d-flex align-items-center"><button type="button" id="play_all"
                                            ...
                                            all</label></div>
																 ...
																 <?php
																			 ...
																			 $qq="select COUNT(*) as 'count' from albumfav where albumid = '$x' and userid ='$idd'";
																			 ...
																			 elseif($rowcount['count']==0){
																				 ...
																				 echo "</button>";
																			 		...
																			 		$q="select COUNT(*) as 'count' from albumfav where albumid = '$x'";
																				...
																				if(isset($_POST["favv"])){
																					$con=mysqli_connect("localhost","root","","music");
																					$qqqq="INSERT INTO `albumfav` (`albumid`, `userid`) VALUES ('$x','$idd')";
																					$rrr=mysqli_query($con,$qqqq);
																					if($r)
		                                      {
		                                          echo"<script>location.href='album-details.php?id=$x'</script>";
		                                      }
																				}
																				if(isset($_POST["fav"])){
																					$con=mysqli_connect("localhost","root","","music");
																					$qqqq="DELETE FROM `albumfav` WHERE albumid = '$x' and userid ='$idd'";
																					$rrr=mysqli_query($con,$qqqq);
																					if($r)
		                                      {
		                                          echo"<script>location.href='album-details.php?id=$x'</script>";
                    ...
                    <div class="list">
                        <div class="row" data-collection-song-id="1">
                            <div class="col-xl-6">
                              ...
                              <?php
                                      $con=mysqli_connect("localhost","root","","music");
                                      $q="select * from music where albumid = '$x'";
                                      $r=mysqli_query($con,$q);
                                      $i=1;
                                      while($row=mysqli_fetch_array($r)){
