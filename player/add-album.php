                          ...
                          <!-- the add music card -->
                            <div class="card">
                                    ...
                                    <div class="mat-tabs">
                                        <ul class="nav nav-tabs" id="add_music" role="tablist">
                                            <li class="nav-item" role="presentation"><button class="nav-link active"
                                                    ...
                                                    aria-selected="true">Select Album</button></li>
                                      ...
                                      <!-- add music pane -->
                                        <div class="tab-pane fade show active" id="music_pane" role="tabpanel"
                                            ...
                                            <form id="add-music-form" action="javascript:void(0);" class="row"  method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="col-12 mb-4"><select class="form-select" name="album" id="cars"
                                                        placeholder="Album">
                                ...
                                <div class="card-footer text-center">
                                    <button  type="submit" onclick="selectalbum()" class="btn btn-primary" name="sub" style="min-width: 140px;">Select Album</button>
                                         <button
                        ...
                        <div class="col-xl-7 col-md-10 mx-auto">
                          ...
                          <!-- the add music card -->
                            <div class="card">
                                    ...
                                    <div class="mat-tabs">
                                        <ul class="nav nav-tabs" id="add_music" role="tablist">
                                            <li class="nav-item" role="presentation"><button class="nav-link active"
                                                    id="music" data-bs-toggle="tab" data-bs-target="#music_pane"
                                                    type="button" role="tab" aria-controls="music_pane"
                                                    aria-selected="true">Add Album</button></li>
                                      ...
                                      <!-- add music pane -->
                                        <div class="tab-pane fade show active" id="music_pane" role="tabpanel"
                                            ...
                                            <form id="add-music" action="javascript:void(0);" class="row"  method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="col-12 mb-4"><input type="text" class="form-control validate" id="p1" name="name" onBlur="checkAvailability()"
                                                ...
                                                <div class="col-12 mb-4"><label for="song_file_1"
                                                      class="form-label">Album Image</label> <input type="file" id="file" name="file" accept="image/jpg, image/jpeg, image/png"
                                ...
                                <div class="card-footer text-center">
                                    <button  type="submit" onclick="addalbum()" class="btn btn-primary" name="sub" style="min-width: 140px;">Add Album</button>
                                         <button
                                        class="btn btn-outline-secondary">Cancel</button></div>
